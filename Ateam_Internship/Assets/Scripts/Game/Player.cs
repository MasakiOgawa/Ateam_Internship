...
public class Player : MonoBehaviour
{
	...
	void Start()
	{
		PlayerParty = new DEFINE.Party(
			new DEFINE.Character(100, 20, DEFINE.PUZZLE_PIECE_SUIT.SPADE, DEFINE.PUZZLE_PIECE_SUIT.CLUB),			// リーダー
			new DEFINE.Character(100, 20, DEFINE.PUZZLE_PIECE_SUIT.DIAMOND, DEFINE.PUZZLE_PIECE_SUIT.HEART),      // キャラ1(アイコン 左)
			new DEFINE.Character(100, 20, DEFINE.PUZZLE_PIECE_SUIT.HEART, DEFINE.PUZZLE_PIECE_SUIT.DIAMOND),			// キャラ2(アイコン 中)
			new DEFINE.Character(100, 20, DEFINE.PUZZLE_PIECE_SUIT.CLUB, DEFINE.PUZZLE_PIECE_SUIT.SPADE));			// キャラ3(アイコン 右)
